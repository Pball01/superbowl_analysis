...
if __name__ == '__main__':
    ...
    calculate_sentiments(before_df).to_csv(r'preprocessed/before_df.csv')
    calculate_sentiments(after_df).to_csv(r'preprocessed/after_df.csv')
    calculate_sentiments(after_superbowl_df).to_csv(r'preprocessed/after_superbowl_df.csv')
